...
public class ReadHandlerTest extends TestBase {
    ...
    public void handleRequest_NotFound_Fails() {
        ...
        final DescribeLocalGatewayRouteTableVpcAssociationsResponse response = DescribeLocalGatewayRouteTableVpcAssociationsResponse
            .builder()
            .localGatewayRouteTableVpcAssociations(Collections.emptyList())
            .build();
    ...
    @Test
    public void handleRequest_MultipleAssociations_Fails() {
        final ReadHandler handler = new ReadHandler();

        final DescribeLocalGatewayRouteTableVpcAssociationsResponse response = DescribeLocalGatewayRouteTableVpcAssociationsResponse
            .builder()
            .localGatewayRouteTableVpcAssociations(TEST_ASSOCIATION, TEST_ASSOCIATION)
            .build();
